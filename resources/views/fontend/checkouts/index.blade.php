    ...
    <main class="pt-90">
        ...
        <section class="shop-checkout container">
            ...
            <div class="checkout-steps">
                <a href="{{ route('cart.checkout.index') }}" class="checkout-steps__item active">
                                ...
                                <div class="col-md-12">
                                    <div class="my-account__address-list">
                                        <div class="my-account__address-list-item">
                                            <div class="my-account_address-item__detail">
                                                <p>{{ $address->name }}</p>
                                                <p>{{ $address->address }}</p>
                            ...
                            <div class="checkout__payment-methods">
                                <div class="form-check">
                                    <input class="form-check-input form-check-input_fill" type="radio"
                                        name="mode" id="mode1" value="googlepay">
                                ...
                                <div class="form-check">
                                    ...
                                    <label class="form-check-label" for="mode13">
                                        Cash on delivery
                                    </label>
                                </div>

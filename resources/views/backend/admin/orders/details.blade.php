                ...
                <table class="table table-striped table-bordered">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $order->delivered_date ? \Carbon\Carbon::parse($order->delivered_date)->format('d M Y') : 'N/A' }}</td>
                            <th>Canceled Date</th>
                            <td>{{ $order->canceled_date ? \Carbon\Carbon::parse($order->canceled_date)->format('d M Y') : 'N/A' }}</td>
                        </tr>
                        <tr>
                            <th>Order Status</th>
                            <td colspan="5">
